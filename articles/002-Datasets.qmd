...
Plotting them is a very helpful way to visualize how many categories there are and the population of each. See @fig-uniques[0], @fig-uniques[1], @fig-uniques[2], @fig-uniques[3], @fig-uniques[4].

```{python}
#| label: fig-uniques
#| layout-ncol: 2
#| fig-cap:
#|   - "Unique values for Employment status"
#|   - "Unique values for Education level"
#|   - "Unique values for Marital status"
#|   - "Unique values for Dwelling"
