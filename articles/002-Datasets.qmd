...
Plotting them is a very helpful way to visualize how many categories there are and the population of each. See @fig-uniques, @fig-uniques, @fig-uniques, @fig-uniques, @fig-uniques.
